        ...
        <div className="mx-auto flex lg:flex-row flex-col items-center justify-center">
          ...
          <div className="lg:w-1/2 justify-center lg:p-5 xl:p-7 md:p-5 flex flex-col items-center text-justify">
            ...
            >
              ...
              My journey into technology began with a passion for solving complex problems, 
              which led me to pursue a career in software engineering. Over the years, 
              I have built a strong foundation in coding, system design, and teamwork, 
              while continuously striving to improve my skills.<br/><br/>

              These experiences have not only strengthened my technical abilities but have 
              also allowed me to connect with like-minded professionals and foster 
              lasting relationships. I am constantly motivated to learn, grow, 
              and take on new challenges.<br/><br/>
