...
//         <div id="teams" className="flex flex-col text-center mb-4 w-full ">
...
//               </li>
//               <li className="py-2 md:py-3">
//                 Collaborated with a Teams of 4 developers to ensure seamless integration of the application.              
//               </li>
//               <li className="py-2 md:py-3">
